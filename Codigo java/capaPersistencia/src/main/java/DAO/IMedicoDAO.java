...
/**
 * Interfaz IMedicoDAO. Define los métodos para el manejo de médicos en la base
 * de datos.
 *
...
public interface IMedicoDAO {
     ...
     * @throws PersistenciaException Si hubo un error al intentar cambiar el
     * estado.
     */
     ...
     * @throws PersistenciaException Si hubo un error al consultar las
     * especialidades.
     */
     ...
     * @throws excepciones.PersistenciaException Si hubo un error al contar
     * médicos.
     */
     ...
     * @throws PersistenciaException Si ocurre un error al consultar las citas.
     */
    public List<Cita> obtenerCitasPorMedico(Medico medico) throws PersistenciaException;

    /**
     * Obtiene la lista de consultas realizadas por un médico identificado por
     * su cédula profesional.
     *
     * @param cedula Cédula profesional del médico.
     * @return Lista de objetos Consulta asociadas al médico.
     ...
     *
     * @return Cadena con la cédula o identificador del primer médico
     * disponible, o null si no se encuentra alguno.
