...
/**
 * Interfaz que define las operaciones de acceso a datos para las consultas
 * médicas.
 *
 * Proporciona métodos para obtener el estado de una consulta, recuperar
 * información detallada de una consulta a partir del identificador de la cita y
 * actualizar los datos de una consulta existente en la base de datos.
 *
 * Las implementaciones de esta interfaz deben manejar posibles errores mediante
 * la excepción PersistenciaException.
 *
...
public interface IConsultaDAO {
    ...
    /**
     * Obtiene la información completa de una consulta utilizando el
     * identificador de la cita.
     *
     * @param idCita Identificador único de la cita asociada a la consulta.
     * @return Objeto Consulta con la información recuperada, o null si no se
     * encuentra.
     * @throws PersistenciaException Si ocurre un error durante la operación.
     */
